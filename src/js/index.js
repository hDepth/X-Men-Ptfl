...
personagens.forEach((personagem) => {
    personagem.addEventListener('mouseenter', () => {
        ...
        removerSelecaoDoPersonagem(); //clicando com o botao direito na linha código, apertando em refatorar, variavel de escopo global, o vs code cria pra vc automaticamente uma função, basta nomea-la, pique método do java
